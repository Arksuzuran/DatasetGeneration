...
class Simulator:
    ...
    def _init(self, arena, colors, plane_id):
        ...
        cylinder = self.p.loadURDF(f"../data_generator/urdf/{colors[0]}/cylinder.urdf", arena.start_position_cylinder,
        ...
        ball = self.p.loadURDF(f"../data_generator/urdf/{colors[1]}/ball.urdf", arena.start_position_ball,
